...
function ApiProdHitFilterCtrl($scope,$rootScope, $resource, $http, $location,ApiProdHitFilterService) 
{
	...
	$rootScope.emailLink= function()
	{
	 ...
	 {
    	 ApiProdHitFilterService.updateScopeFiltersWithDefaultValues($scope,$rootScope);
    	 ApiProdHitFilterService.updateScopeFiltersWithUrlParamsValues($scope,$rootScope);
    	 ...
    	 ApiProdHitFilterService.loadComboBoxA($scope,$rootScope,$http,url,$location.path(),true);
	 ...
	 $rootScope.resetAdapterInventoryComboBox= function() 
	 {
    	 ...
    	 var url = "/api360-service/resource-finder/lookup/"+$scope.api+"/"+$scope.version+"/"+$scope.profile+"/"+$scope.srtd+"/"+$scope.bundle+"/allfilters.json";
    	 ApiProdHitFilterService.loadComboBoxA($scope,$rootScope,$http,url,$location.path(),false);
	 ...
	 {
		 //alert(name +":"+value);
		 ApiProdHitFilterService.dashboardFilterReload($scope,$rootScope,name, value); 
		 var url = "/api360-service/resource-finder/lookup/"+$scope.api+"/"+$scope.version+"/"+$scope.profile+"/"+$scope.srtd+"/"+$scope.bundle+"/allfilters.json";
		 ApiProdHitFilterService.reloadComboBoxAdapterInventory($scope,$rootScope,$http,url,name);
		 $rootScope.submitAPISchemaSearchSearch();
	 };
