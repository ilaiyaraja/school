'use strict';
console.log("angularjs-dropdown-multiselect-js");
                ...
                $scope.setSelectedItem = function (id, dontRemove, refresh) 
                {
                    ...
                    if(refresh || refresh==undefined)
                	{
                    	 if("/dashboard"==$location.path())
			            	...
			            	else if("/api_resource_finder"==$location.path()) 	  {
			            		
		               			$rootScope.ReLoadResourceFinderComboBox($scope.translationTexts.buttonDefaultText,finalObj.id);	
		               	  }
                           else if("/api_artifact_page"==$location.path()) 	  {
			            		
		               			$rootScope.ReLoadAPIArtifactComboBox($scope.translationTexts.buttonDefaultText,finalObj.id);	
		               	  }
                           else if("/ete_test_result"==$location.path()) 	  {
			            		
		               			$rootScope.ReLoadEteTestResultComboBox($scope.translationTexts.buttonDefaultText,finalObj.id);	
		               	  }
